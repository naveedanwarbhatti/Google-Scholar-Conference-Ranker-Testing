...
- Name: overall badge distribution is correct for Hamad Alizai
- Location: C:\Users\Naveed Bhatti\Documents\Google-Scholar-Conference-Ranker-Testing\tests\ranker.hamad.spec.ts:24:1
...
```ts
   ...
   9 | // CONFIG
  10 | // ───────────────────────────────
  11 | const PROFILE = 'https://scholar.google.com.pk/citations?user=L4lhO6AAAAAJ&hl=en';
  12 |
  13 | const EXPECTED = {
  14 |   'A★': 9,
  15 |   A: 8,
  ...
  22 | // TEST
  23 | // ───────────────────────────────
  24 | test('overall badge distribution is correct for Hamad Alizai', async ({ page }) => {
